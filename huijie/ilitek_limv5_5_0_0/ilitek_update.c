...
static int32_t ilitek_upgrade_2302or2312(uint32_t df_startaddr, uint32_t df_endaddr, uint32_t df_checksum,
...
static int32_t ilitek_upgrade_2511(uint32_t df_startaddr, uint32_t df_endaddr, uint32_t ap_startaddr, uint32_t ap_endaddr, uint8_t *CTPM_FW)
{
...
int32_t ilitek_upgrade_bigger_size_ic(uint32_t df_startaddr, uint32_t df_endaddr, uint32_t df_checksum,
				 uint32_t ap_startaddr, uint32_t ap_endaddr, uint32_t ap_checksum, uint8_t *CTPM_FW)
{
...
#ifdef ILITEK_UPDATE_FW
int32_t ilitek_upgrade_firmware(void)
{
